...
import imgCol1 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/H_M_color_1.png';
import imgCol2 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/H_M_color_2.png';
import img1 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/H_M_no_color_1.png';
import img2 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/H_M_no_color_2.png';
import noise from '../../assets/noise.jpg';

/* Multiple choice answers */

import C1 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/Multiple choice answers/1.png';
import C2 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/Multiple choice answers/2.png';
import C3 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/Multiple choice answers/3.png';
import C4 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/Multiple choice answers/4.png';
import C5 from '../../assets/screenshots/Exercise_4/H_M/Coloured version/Multiple choice answers/5.png';

import N1 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/Multiple choice answers/1.png';
import N2 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/Multiple choice answers/2.png';
import N3 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/Multiple choice answers/3.png';
import N4 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/Multiple choice answers/4.png';
import N5 from '../../assets/screenshots/Exercise_4/H_M/Non-coloured version/Multiple choice answers/5.png';
...
export default class GameScreen4 extends Component {
    ...
    render() {
        ...
        /* Multiple choice answers */
        const choice1 = "Add"
        const choice2 = "Shopping bag"
        const choice3 = "Move to favorites"
        const choice4 = "Cotton T-shirt"
        const choice5 = "Buy now"
        ...
        const instructions = "In this exercise you will again see a screenshot of a real website and the task is the same as before. Try to focus on information that seem important to you."

        /* Multiple choice buttons */
        const choiceButton1 = <div className="col-12 mx-auto"><input type="radio" id="opt1" value={choice1} checked={this.state.value === choice1} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt1"><img className="col-4 p-0 ml-2" src={choice1Img} alt="" /></label></div>
        const choiceButton2 = <div className="col-12 mx-auto"><input type="radio" id="opt2" value={choice2} checked={this.state.value === choice2} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt2"><img className="col-10 p-0 ml-2" src={choice2Img} alt="" /></label></div>
        ...
        const choiceButton4 = <div className="col-12 mx-auto"><input type="radio" id="opt4" value={choice4} checked={this.state.value === choice4} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt4"><img className="col-8 p-0 ml-2" src={choice4Img} alt="" /></label></div>
        const choiceButton5 = <div className="col-12 mx-auto"><input type="radio" id="opt5" value={choice5} checked={this.state.value === choice5} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt5"><img className="col-12 p-0 ml-2" src={choice5Img} alt="" /></label></div>
