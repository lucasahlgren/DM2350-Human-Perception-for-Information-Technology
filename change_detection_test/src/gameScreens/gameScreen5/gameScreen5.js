...
import imgCol1 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/netflix_color_1.jpg';
import imgCol2 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/netflix_color_2.jpg';
import img1 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/netflix_no_color_1.jpg';
import img2 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/netflix_no_color_2.jpg';
import noise from '../../assets/noise.jpg';

/* Multiple choice answers */

import C1 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/Multiple choice answers/1.png';
import C2 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/Multiple choice answers/2.png';
import C3 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/Multiple choice answers/3.png';
import C4 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/Multiple choice answers/4.png';
import C5 from '../../assets/screenshots/Exercise_5/Netflix/Coloured version/Multiple choice answers/5.png';

import N1 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/Multiple choice answers/1.png';
import N2 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/Multiple choice answers/2.png';
import N3 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/Multiple choice answers/3.png';
import N4 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/Multiple choice answers/4.png';
import N5 from '../../assets/screenshots/Exercise_5/Netflix/Non-coloured version/Multiple choice answers/5.png';


export default class GameScreen4 extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        /* Multiple choice answers */
        const choice1 = "Play"
        const choice2 = "The Haunting of Hill House"
        const choice3 = "Kids"
        const choice4 = "Episodes"
        const choice5 = "3 Season"
        ...
        const instructions = "In this exercise you will again see a screenshot of a real website and the task is the same. Try to focus on information that seem important to you. This is the last exercise."

        /* Multiple choice buttons */
        const choiceButton1 = <div className="col-12 mx-auto"><input type="radio" id="opt1" value={choice1} checked={this.state.value === choice1} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt1"><img className="col-6 p-0 ml-2" src={choice1Img} alt="" /></label></div>
        const choiceButton2 = <div className="col-12 mx-auto"><input type="radio" id="opt2" value={choice2} checked={this.state.value === choice2} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt2"><img className="col-12 p-0 ml-2" src={choice2Img} alt="" /></label></div>
        const choiceButton3 = <div className="col-12 mx-auto"><input type="radio" id="opt3" value={choice3} checked={this.state.value === choice3} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt3"><img className="col-5 p-0 ml-2" src={choice3Img} alt="" /></label></div>
        const choiceButton4 = <div className="col-12 mx-auto"><input type="radio" id="opt4" value={choice4} checked={this.state.value === choice4} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt4"><img className="col-7 p-0 ml-2" src={choice4Img} alt="" /></label></div>
        const choiceButton5 = <div className="col-12 mx-auto"><input type="radio" id="opt5" value={choice5} checked={this.state.value === choice5} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt5"><img className="col-7 p-0 ml-2" src={choice5Img} alt="" /></label></div>
        ...
        if (finished && nextExercise) {
            this.button = <button onClick={this.props.changeStage} className="btn btn-success btn-rounded btn-block m-4 mx-auto">Finish the game</button>
        }
        else {
            this.button = null
        }
