...
import imgCol1 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Wire1_color_1.png';
import imgCol2 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Wire1_color_2.png';
import img1 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Wire1_no_color_1.png';
import img2 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Wire1_no_color_2.png';
import noise from '../../assets/noise.jpg';

/* Multiple choice answers */

import C1 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Multiple choice answers/1.png';
import C2 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Multiple choice answers/2.png';
import C3 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Multiple choice answers/3.png';
import C4 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Multiple choice answers/4.png';
import C5 from '../../assets/screenshots/Exercise_1/Wireframe 1/Coloured version/Multiple choice answers/5.png';

import N1 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Multiple choice answers/1.png';
import N2 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Multiple choice answers/2.png';
import N3 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Multiple choice answers/3.png';
import N4 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Multiple choice answers/4.png';
import N5 from '../../assets/screenshots/Exercise_1/Wireframe 1/Non-coloured version/Multiple choice answers/5.png';


export default class GameScreen1 extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        /* Multiple choice answers */
        const choice1 = "Welcome"
        const choice2 = "This is a sub-headline"
        const choice3 = "Description of image"
        const choice4 = "Read more"
        const choice5 = "Like"
        ...
        const instructions = "You will be shown a simple wireframe of a website layout. Your task is to read all texts displayed and then see if you spot a change. By all text we mean including labels, buttons, links and numbers."

        /* Multiple choice buttons */
        const choiceButton1 = <div className="col-12 mx-auto"><input type="radio" id="opt1" value={choice1} checked={this.state.value === choice1} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt1"><img className="col-8 p-0 ml-2" src={choice1Img} alt="" /></label></div>
        ...
        const choiceButton3 = <div className="col-12 mx-auto"><input type="radio" id="opt3" value={choice3} checked={this.state.value === choice3} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt3"><img className="col-12 p-0 ml-2" src={choice3Img} alt="" /></label></div>
