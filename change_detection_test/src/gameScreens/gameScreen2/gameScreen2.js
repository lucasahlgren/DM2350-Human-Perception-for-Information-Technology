...
import imgCol1 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Wire2_color_1.png';
import imgCol2 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Wire2_color_2.png';
import img1 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Wire2_no_color_1.png';
import img2 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Wire2_no_color_2.png';
import noise from '../../assets/noise.jpg';

/* Multiple choice answers */

import C1 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Multiple choice answers/1.png';
import C2 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Multiple choice answers/2.png';
import C3 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Multiple choice answers/3.png';
import C4 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Multiple choice answers/4.png';
import C5 from '../../assets/screenshots/Exercise_2/Wireframe 2/Coloured version/Multiple choice answers/5.png';

import N1 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Multiple choice answers/1.png';
import N2 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Multiple choice answers/2.png';
import N3 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Multiple choice answers/3.png';
import N4 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Multiple choice answers/4.png';
import N5 from '../../assets/screenshots/Exercise_2/Wireframe 2/Non-coloured version/Multiple choice answers/5.png';


export default class GameScreen2 extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        /* Multiple choice answers */
        const choice1 = "Save changes"
        const choice2 = "Other"
        const choice3 = "Zip code"
        const choice4 = "Change image"
        const choice5 = "Cancel"
        ...
        const instructions = "In this exercise a slightly more complex layout of a website form will be displayed. Your task is to read all texts displayed and then see if you spot a change. By all text we mean including labels, buttons, links and numbers."

        /* Multiple choice buttons */
        const choiceButton1 = <div className="col-12 mx-auto"><input type="radio" id="opt1" value={choice1} checked={this.state.value === choice1} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt1"><img className="col-9 p-0 ml-2" src={choice1Img} alt="" /></label></div>
        const choiceButton2 = <div className="col-12 mx-auto"><input type="radio" id="opt2" value={choice2} checked={this.state.value === choice2} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt2"><img className="col-6 p-0 ml-2" src={choice2Img} alt="" /></label></div>
        const choiceButton3 = <div className="col-12 mx-auto"><input type="radio" id="opt3" value={choice3} checked={this.state.value === choice3} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt3"><img className="col-6 p-0 ml-2" src={choice3Img} alt="" /></label></div>
        const choiceButton4 = <div className="col-12 mx-auto"><input type="radio" id="opt4" value={choice4} checked={this.state.value === choice4} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt4"><img className="col-11 p-0 ml-2" src={choice4Img} alt="" /></label></div>
        const choiceButton5 = <div className="col-12 mx-auto"><input type="radio" id="opt5" value={choice5} checked={this.state.value === choice5} onChange={this.handleChange} /><label className="col-10 pr-0" htmlFor="opt5"><img className="col-6 p-0 ml-2" src={choice5Img} alt="" /></label></div>
